...
export const SKILL_DEFINITIONS: SkillDefinition[] = [
  ...
  },
  {
    key: "investigation",
    label: "Investigación",
    labels: { es: "Investigación", en: "Investigation" },
    ability: "INT",
  ...
  },
  {
    key: "religion",
    label: "Religión",
    labels: { es: "Religión", en: "Religion" },
    ability: "INT",
  ...
  },
  {
    key: "perception",
    label: "Percepción",
    labels: { es: "Percepción", en: "Perception" },
    ability: "WIS",
  ...
  },
  {
    key: "intimidation",
    label: "Intimidación",
    labels: { es: "Intimidación", en: "Intimidation" },
    ability: "CHA",
  ...
  },
  {
    ...
    labels: { es: "Interpretación", en: "Performance" },
    ability: "CHA",
  ...
  },
  {
    key: "persuasion",
    label: "Persuasión",
    labels: { es: "Persuasión", en: "Persuasion" },
    ability: "CHA",
